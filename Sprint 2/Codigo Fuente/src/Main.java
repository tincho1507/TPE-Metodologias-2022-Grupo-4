...
public class Main {
				  ...
				  else
				  {
					...
					if (medicosDisponible.size() != 0){
						...
						if (indiceMedicoSeleccionado >= 0 && indiceMedicoSeleccionado < medicosDisponible.size())
						{
							...
							//Ingresa si quiere el turno por la ma̱ana o la tarde
 ...
 //-------------------------------------------------------MODULOS-------------------------------------------------------------------//
	public static InstitucionMedica generarInstitucion() {
		...
		//Creo arrayList de obra sociales y a̱ado obras sociales a la lista
		...
		//Le a̱ado los turnos a los medicos
		m.add(t1);
		m1.add(t2);
		m2.add(t3);
		...
		//Creo Arraylist de medicos y a̱ado m,m1 y m2
